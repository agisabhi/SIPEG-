...
<head>
    ...
    <!-- Page plugins -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/bootstrap/bootstrap.css"/> <!-- Load file css jquery-ui -->

    <link rel="stylesheet" href="<?= base_url(); ?>assets/jquery-ui/jquery-ui.min.css"/> <!-- Load file css jquery-ui -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/datepicker/dist/css/bootstrap-datepicker.min.css"/> <!-- Load file css jquery-ui -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/datepicker/dist/js/bootstrap-datepicker.min.js"/> <!-- Load file css jquery-ui -->
