<body>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h2 class="mb-0">Data Gaji Pegawai Villa Kancil</h2>
                        </div>
    ...
    <form method="get" action="">
        ...
        <a href="<?php echo base_url('laporan_pemilik/gaji'); ?>" class="btn btn-default">Reset Filter</a>
        <a href="<?php echo base_url('pemilik/laporan'); ?>" class="btn btn-danger">Kembali</a>
    </form>
    <hr />
    
    <div><a href="<?php echo $url_cetak; ?>" class="btn btn-success">CETAK PDF</a></div>
    <br><b><?php echo $ket; ?></b><br />
