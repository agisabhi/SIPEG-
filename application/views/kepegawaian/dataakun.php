                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h2 class="mb-0">Data Akun Pegawai Villa Kancil</h2>
                        </div>
                        <!-- Search form -->
                                ...
                                <tbody class="list">
                                    ...
                                    <?php foreach ($login as $a) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url(); ?>kepegawaian/editakun/<?= $a['id'] ?>" class="btn btn-success btn-sm"><i class="ni ni-active-40">Edit</i></a>
