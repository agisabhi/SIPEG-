                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h2 class="mb-0">Data Absensi Pegawai Villa Kancil</h2>
                        </div>
                        <!-- Search form -->
                                ...
                                <tbody class="list">
                                    ...
                                    <?php foreach ($pegawai as $a) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url(); ?>kepegawaian/detailabsen/<?= $a['nip'] ?>" class="btn btn-primary btn-sm"><i class="ni ni-active-40">Detail</i></a>
