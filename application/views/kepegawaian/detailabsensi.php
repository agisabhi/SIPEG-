                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h2 class="mb-0">Data Absensi Pegawai Villa Kancil <br>NIP : <?=$nip;?></h2>
                        </div>
      ...
      foreach($transaksi as $data) :?>
        ...
        <tbody class="list">
            <tr>
                ...
                <td>
                    <a href="<?= base_url(); ?>kepegawaian/editpresensi/<?= $data['no_absen'] ?>" class="btn btn-success btn-sm"><i class="ni ni-active-40">Edit</i></a>
                </td>
            </tr>
        </tbody>
        <?php $no++;?>
