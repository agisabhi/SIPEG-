                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="card-title text-uppercase text-muted mb-0">Jumlah Absensi Hari ini</h5>
                                            <span class="h2 font-weight-bold mb-0"><?= $jum_abs; ?></span>
                                        </div>
                                        <div class="col-auto">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-1">
                            <a class="btn btn-icon btn-primary" type="button" href="<?= base_url(); ?>kepegawaian/tambahpegawai">
                                <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                                <span class="btn-inner--text">Tambah Data Pegawai</span>
                            </a>
                        </div>
                                ...
                                <tbody class="list">
                                    ...
                                    <?php foreach ($pegawai as $a) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url(); ?>kepegawaian/editpegawai/<?= $a['nip'] ?>" class="btn btn-success btn-sm"><i class="ni ni-active-40">Edit</i></a>
