                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="">
                                <h6 class="heading-small text-muted mb-4">Ubah Akun Pegawai</h6>
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Nomor Induk Pegawai</label>
                                                <input type="number" id="input-username" class="form-control" placeholder="NIP" name="nip" value="<?= $idlog['nip']; ?>" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-email" class="form-control" placeholder="password" name="password" value="<?= $idlog['password']; ?>" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="<?=base_url();?>kepegawaian/data_akun" class="btn btn-danger">Kembali</a>
                                        </div>
                                    </div>
                                </div>
                        </div>
