                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <?php foreach($cuti as $c):?>
                                                ...
                                                <input type="text" id="input-username" class="form-control" value="<?= $c['nip']; ?>" name="nipu" required readonly>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-email" class="form-control" value="<?= $c['nama']; ?>" name="nama" required readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="alasan" class="form-control date" name="alasan" value="<?=$c['alasan'];?>" required readonly>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="tgl_mulai" class="form-control date" name="tanggal_mulai" value="<?=$c['tanggal_mulai'];?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-first-name">Tanggal Selesai</label><br>
                                                <input type="text" id="tgl_akhir" class="form-control date" name="tanggal_selesai" value="<?=$c['tanggal_selesai'];?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-first-name">Catatan</label><br>
                                                <input type="text" class="form form-control" name="catatan" placeholder="(Optional)" >
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-first-name">Status Persetujuan</label><br>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <a href="<?=base_url();?>kepegawaian/kepcuti" class="btn btn-danger my-6">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
