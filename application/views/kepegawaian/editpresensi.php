                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-username" class="form-control" placeholder="NIP" name="nip" value="<?=$idpeg['nip']; ?>" required readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_status" required class="form form-control">
                                                    <?php if($idpeg['id_status']=='1'):?>
                                                    <option value="1" selected>Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" >Pulang Awal</option>
                                                    <option value="4" >Terlambat & Pulang Awal</option>
                                                    <option value="6" >Alpa</option>
                                                    <option value="7" >Izin</option>
                                                    <option value="8" >Sakit</option>
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>

                                                    <?php elseif($idpeg['id_status']=='2'):?>
                                                    ...
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>
                                                    <?php elseif($idpeg['id_status']=='3'): ?>
                                                    <option value="1" >Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" selected>Pulang Awal</option>
                                                    <option value="4" >Terlambat & Pulang Awal</option>
                                                    <option value="6" >Alpa</option>
                                                    <option value="7" >Izin</option>
                                                    <option value="8" >Sakit</option>
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>
                                                    <?php elseif($idpeg['id_status']=='4'): ?>
                                                    <option value="1" >Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" >Pulang Awal</option>
                                                    <option value="4" selected>Terlambat & Pulang Awal</option>
                                                    <option value="6" >Alpa</option>
                                                    <option value="7" >Izin</option>
                                                    <option value="8" >Sakit</option>
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>
                                                    <?php elseif($idpeg['id_status']=='6'): ?>
                                                    <option value="1" >Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" >Pulang Awal</option>
                                                    <option value="4" >Terlambat & Pulang Awal</option>
                                                    <option value="6" selected>Alpa</option>
                                                    <option value="7" >Izin</option>
                                                    <option value="8" >Sakit</option>
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>
                                                    <?php elseif($idpeg['id_status']=='7'): ?>
                                                    <option value="1" >Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" >Pulang Awal</option>
                                                    <option value="4" >Terlambat & Pulang Awal</option>
                                                    <option value="6" >Alpa</option>
                                                    <option value="7" selected>Izin</option>
                                                    <option value="8" >Sakit</option>
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>
                                                    <?php elseif($idpeg['id_status']=='8'): ?>
                                                    <option value="1" >Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" >Pulang Awal</option>
                                                    <option value="4" >Terlambat & Pulang Awal</option>
                                                    <option value="6" >Alpa</option>
                                                    <option value="7" >Izin</option>
                                                    <option value="8" selected>Sakit</option>
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>
                                                    <?php elseif($idpeg['id_status']=='9'): ?>
                                                    <option value="1" >Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" >Pulang Awal</option>
                                                    <option value="4" >Terlambat & Pulang Awal</option>
                                                    ...
                                                    <option value="7" >Izin</option>
                                                    <option value="8" >Sakit</option>
                                                    <option value="9" selected>Tidak Presensi Pulang</option>
                                                    <option value="10" >Terlambat & Tidak Presensi Pulang</option>
                                                    <?php elseif($idpeg['id_status']=='10'): ?>
                                                    <option value="1" >Hadir</option>
                                                    <option value="2" >Terlambat</option>
                                                    <option value="3" >Pulang Awal</option>
                                                    <option value="4" >Terlambat & Pulang Awal</option>
                                                    ...
                                                    <option value="8" >Sakit</option>
                                                    <option value="9" >Tidak Presensi Pulang</option>
                                                    <option value="10" selected>Terlambat & Tidak Presensi Pulang</option>
                                                <?php endif;?>
                                                </select>
                                            </div>
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-success my-4">Ubah</button>
                                                <a href="<?=base_url();?>kepegawaian/absensi_pegawai" class="btn btn-danger">Kembali</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
