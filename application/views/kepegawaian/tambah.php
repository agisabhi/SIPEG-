                            ...
                            <form method="post" action="tambahpegawai">
                                ...
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="input-username" class="form-control" placeholder="NIP" name="nip" value="<?= sprintf("%03s",$nip);?>" readonly>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-email" class="form-control" placeholder="nama" name="nama" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-last-name">Password Akun</label>
                                                <input type="text" id="input-last-name" class="form-control" placeholder="Password" name="password" required>
                                                <small class="from-text text-danger"><?= form_error('password'); ?></small>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="7" id="input-last-name" class="form-control" placeholder="Alamat" name="alamat" required></textarea>
                                            </div>
