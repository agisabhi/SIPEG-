<body>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h2 class="mb-0">Data Presensi Pegawai Villa Kancil <br>NIP : <?=$nip;?></h2>
                        </div>
    ...
    <form method="get" action="">
        ...
        <a href="<?php echo base_url('kepegawaian/detailabsen/'.$nip); ?>" class="btn btn-default">Reset Filter</a>
        <a href="<?php echo base_url('kepegawaian/absensi_pegawai'); ?>" class="btn btn-danger">Kembali</a>
    </form>
    <hr />
        ...
        <tbody class="list">
            <tr>
                ...
                <td><?php if($data['id_status']==1){
                    ...
                    ?><span class="badge badge-default">HADIR, Terlambat Datang</span><?php
                }else if($data['id_status']==3){
                    ?><span class="badge badge-default">HADIR, Pulang Awal</span><?php
                }else if($data['id_status']==4){
                    ?><span class="badge badge-default">HADIR, Terlambat & Pulang Awal</span><?php
