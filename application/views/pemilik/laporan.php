						...
						<div class="card-body">
							<div class="row icon-examples">
								<div class="col-lg-4 col-md-9">
									<a href="<?=base_url();?>laporan_pemilik" class="btn-icon-clipboard" title="Laporan Presensi">
										<div>
								...
								<div class="col-lg-4 col-md-9">
									<a href="<?=base_url();?>laporan_pemilik/gaji" class="btn-icon-clipboard" title="Laporan Gaji">
										<div>
								...
								<div class="col-lg-4 col-md-9">
									<a href="<?=base_url();?>laporan_pemilik/cuti" class="btn-icon-clipboard" title="Laporan Cuti">
										<div>
                            ...
                            <div class="row icon-examples">
                            <div class="col-lg-4 col-md-9">
									<a href="<?=base_url();?>laporan_pemilik/pegawai" class="btn-icon-clipboard" title="Laporan Pegawai">
										<div>
