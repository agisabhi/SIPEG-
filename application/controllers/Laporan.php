...
public function index(){ 
	...
	if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
        ...
        $config['base_url'] = "http://localhost/sipeg/laporan/index";
...
<td width="100%" align="center"><h1>Laporan Presensi Pegawai<br>Villa Kancil Kampoeng Sunda</h1></td>
</tr>
        ...
        $pdf->WriteHTML($html);
        $pdf->Output('Laporan Presensi.pdf', 'D');
    }
    ...
    public function gaji(){
        ...
        if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
            ...
            $this->load->library('pagination');
            $config['base_url'] = "http://localhost/sipeg/laporan/gaji";
            $config['total_rows'] = $total_rows;
            $config['per_page'] = 10;
...
<td width="100%" align="center"><h1 align="center">Laporan Gaji Pegawai<br>Villa Kancil Kampoeng Sunda</h1></td>
</tr>
	...
	if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
            ...
            if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                ...
                $url_cetak = 'laporan/cetakcuti?jenis='.$jenis.'filter=1&tanggal='.$tgl;
                ...
                $url_cetak = 'laporan/cetakcuti?jenis='.$jenis.'&filter=2&bulan='.$bulan.'&tahun='.$tahun;
                ...
                $url_cetak = 'laporan/cetakcuti?jenis='.$jenis.'&filter=3&tahun='.$tahun;
            ...
            if($jenis=="Menikah"){
                ...
                $url_cetak = 'laporan/cetakcuti?jenis='.$jenis;
        ...
        $this->load->library('pagination');
        $config['base_url'] = "http://localhost/sipeg/laporan/cuti";
        $config['total_rows'] = $total_rows;
        $config['per_page'] = 10;
...
$header = '
<table width="100%"><tr>
<td width="30%" align="right"><img src="assets/img/brand/villakancil.png" width="200px" /></td>
<td width="90%" align="center"><h1 align="center">Laporan Cuti Pegawai<br>Villa Kancil Kampoeng Sunda</h1></td>
	...
	if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
            $filter = $_GET['filter']; // Ambil data filder yang dipilih user
                ...
                $url_cetak = 'laporan/cetakpegawai?bagian='.$filter;
            ...
            $url_cetak = 'laporan/cetakpegawai';
    ...
    public function cetakpegawai(){
        if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
            $filter = $_GET['filter']; // Ambil data filder yang dipilih user
                ...
                $transaks = $this->LaporanAbsensi_model->view_by_bagian_print(); // Panggil fungsi view_by_date yang ada di TransaksiModel
